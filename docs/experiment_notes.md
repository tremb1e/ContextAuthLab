...
| C5 | Landscape touch challenge - Blue ball tapping | Low-medium tap bursts | small grip transients | 1-8Hz | touch timing, repeated taps, game-like UI | target tapping in landscape |
| C6 | Video watching - Local video playback | Low posture drift | slow roll/pitch | near DC to 2Hz | Surface/VideoView, play/pause, speed, seek | comfortable video viewing |
